...
Students must also complete a **dry run of the presentation** with their advisor **before the final presentation** or they will not be permitted to present. The student is responsible for scheduling the dry run with their advisor.

The **exit questionnaire** must be completed **before grades are reported** or the student will receive a failing grade for the course.
:::

### Defense Documentation Structure

::: info The final defense documentation shall include the following chapters:
...
5.  Project Implementation Description & Explanation  
    *This section details the design and features of the project in paragraph form with references to the following:*
...
| Exit Questionnaire   | *Required for Grade* |
...
All students are expected to adhere to [Charleston Southern University's Academic Integrity Policy](https://www.charlestonsouthern.edu/wp-content/uploads/CSU-Policy-R-58-updated-April-2026.pdf) and the [Computer Science Departmental Guidelines](/integrity). For example, all work must be original and must not be copied from another student. Failure to follow this guideline will be considered a violation of the code and will be treated accordingly. Students are encouraged to ask their instructor(s) for clarification regarding their academic integrity.

### AI Policy for CSCI 499

**Level 2. Permitting or prohibiting AI use on an assignment-by-assignment basis in CSCI 499.**

The use of generative AI is prohibited for all work on your senior project unless expressly granted by your project advisor. Such permission may be rare and highly dependent on the project and deliverables. To comprehend the various concepts presented in the course material takes considerable effort and practice. Accordingly, the use of artificial intelligence (AI) tools is generally prohibited in this course but will be permitted for select deliverables.

Generative artificial intelligence (AI) tools are prohibited from use in any step in the process of creating the test plan (idea generation, outlining, writing, etc.).
...
1.  **Acknowledge the Tool** For example:  
